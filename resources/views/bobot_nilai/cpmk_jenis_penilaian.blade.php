...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="formBobotJenisPenilaian" method="POST" action="{{ route('bobot_nilai.cpmk.store_jenis_penilaian', ['mataKuliah' => $mataKuliah->getKey(), 'cpmk' => $cpmk->id]) }}">
                @csrf
                    ...
                    <table class="table table-bordered table-hover" id="jenisPenilaianTable">
                        ...
                        <tbody>
                            @foreach ($jenisPenilaianList as $jenis)
                                @php
                                    // Mengubah $jenis menjadi key yang valid untuk array (misal, 'Keaktifan' menjadi 'keaktifan')
                                    // dan untuk nama input field.
                ...
                <div class="alert alert-info mt-3">
                    Total bobot untuk semua jenis penilaian (Keaktifan, Tugas, Kuis, Proyek, UTS, UAS) yang diisi harus 100%.
                </div>
                <div class="mt-3">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i> Simpan Bobot Jenis Penilaian</button>
                </div>
            </form>
        </div>
    </div>
...
<style>
    ...
    .table td.text-start { /* Memastikan kolom jenis penilaian tetap rata kiri */
