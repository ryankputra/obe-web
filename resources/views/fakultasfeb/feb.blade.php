...
@section('title', 'fakultas Ekonomi dan Bisnis')
...
<div class="container-fluid">
    ...
    <h1 class="mb-4 text-purple">Fakultas Ekonomi dan Bisnis</h1>
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>50</td>
                            <td>
                                <a href="{{ route('fakultasfeb.feb.Akuntansi') }}" class="btn btn-outline-info btn-sm">Lihat</a>
                        ...
                        <tr>
                            <td class="text-start">Sistem Management</td>
                            <td>60</td>
                            <td>
                                <a href="{{ route('fakultasfeb.feb.sistemmanegement') }}" class="btn btn-outline-info btn-sm">Lihat</a>
