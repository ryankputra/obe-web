...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize active buttons and hidden inputs based on old input (if any)
    // This ensures that if validation fails and the page reloads,
    // previously selected dosens are still marked as active and their hidden inputs are present.
