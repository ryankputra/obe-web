...
@section('title', 'Mahasiswa - Vokasi - Management Keuangan')

@section('content')
<div class="container-fluid">
    <div class="mb-4">
        <a href="{{ route('fakultasVokasi.Vokasi') }}" class="btn btn-secondary back-btn">
            <i class="fas fa-arrow-left me-2"></i> Kembali
        </a>
    </div>
    
    <h1 class="mb-4 text-purple">Mahasiswa - VOKASI - Management Keuangan</h1>
