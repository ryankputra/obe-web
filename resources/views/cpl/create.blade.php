...
<div class="container mt-4">
    <h2 class="mb-4 text-purple">Tambah CPL</h2>
        ...
        <form method="POST" action="{{ route('cpl.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kode_cpl') is-invalid @enderror"
                    id="kode_cpl" name="kode_cpl" value="{{ old('kode_cpl') }}" placeholder="Contoh: CPL001" required>
                @error('kode_cpl')
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                    id="deskripsi" name="deskripsi" rows="5" placeholder="Masukkan deskripsi CPL" required>{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
