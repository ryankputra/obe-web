...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-end mb-3">
        ...
        <button class="btn btn-primary rounded-circle d-flex justify-content-center align-items-center" style="width: 40px; height: 40px;" id="saveAllButton">
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{ $prodi->id }}">
                            ...
                            <td>
                                <a href="{{ route('fakultasfst.sains-teknologi.detail', $prodi->id) }}" class="btn btn-outline-info btn-sm">Lihat</a>
            ...
            <form id="addProdiForm" action="{{ route('fakultasfst.prodi.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="jumlahMahasiswa" name="jumlah_mahasiswa" required>
                    </div>
                </div>
            ...
            <form id="editProdiForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control text-start" id="editProdiNama" name="nama_prodi" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="editJumlahMahasiswa" class="form-label">Jumlah Mahasiswa</label>
                        <input type="number" class="form-control" id="editJumlahMahasiswa" name="jumlah_mahasiswa" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
